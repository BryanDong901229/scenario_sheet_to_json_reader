...
def xlsx_to_json(worksheet,f):
        ...
        f.write('\n\t"maps": [')
        #map1
        if worksheet.cell(3,2).value == 'curve':
                f.write("\n\t{")
                f.write('\n\t\t%s,'% worksheet.cell(3,3).value)
                f.write('\n\t\t%s,'% worksheet.cell(3,4).value)
                f.write('\n\t\t%s,'% worksheet.cell(3,5).value)
                f.write('\n\t\t%s'% worksheet.cell(3,6).value)
                f.write('\n\t\t\t%s,'% worksheet.cell(3,7).value)
                f.write('\n\t\t\t%s,'% worksheet.cell(3,8).value)
                f.write('\n\t\t\t%s'% worksheet.cell(3,9).value)
                f.write('\n\t\t]')
                f.write("\n\t}")
                f.write('\n\t],')
        elif worksheet.cell(3,2).value == 'straight':
                f.write("\n\t{")
                f.write('\n\t\t%s,'% worksheet.cell(3,3).value)
                f.write('\n\t\t%s,'% worksheet.cell(3,4).value)
                f.write('\n\t\t%s,'% worksheet.cell(3,5).value)
